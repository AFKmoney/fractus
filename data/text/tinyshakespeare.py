"""Dataset tinyshakespeare pour l'entraînement du transformer fractal.

Charge le texte, encode en ids (niveau caractère), découpe en séquences
de longueur fixe pour l'entraînement par batch.
"""
...
class TinyShakespeareDataset(Dataset):
    """Dataset tinyshakespeare niveau caractère.

    Args:
        seq_len  : longueur des séquences.
        path     : chemin du fichier texte (défaut : data/text/tinyshakespeare.txt).
    ...
    def __getitem__(self, idx: int) -> Tuple[torch.Tensor, torch.Tensor]:
        """Retourne (input_ids, target_ids) où target = input décalé de 1."""
